...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
	...
	$output='<div style="border:1px solid;width:75%;margin: auto;padding: 10px;"><div <img  src="miscos.png" alt="logo" class="miscos">style="margin:0px;padding:0px;"><h2  align="center" style="height:10px;">MISCOS TECHNOLOGIES PVT.LTD.</h2>';
			 $output.='<p align="center"style="margin:0px;padding:0px;font-weight:bold;font-size:12px;height:20px;">Invoice For Advertisement</p></div><hr>';
			 $output.='<p style="font-weight:bold;font-size:12px;height:20px;float:right;padding-right:10%;">Date : '.date('d-m-Y').'</p>';
				$output.='<table width="100%" cellspacing="5" cellpadding="5" style="margin-bottom:50px;">';
			
				$output.='
				
				<table style="font-family: arial, sans-serif;border-collapse: collapse;width: 90%;margin: auto;margin-bottom:50px; border:1px solid;">
			    <tr>
					<td style="border: 1px solid black;text-align: left;padding: 8px;width:1%;">'.$name.'</td>
